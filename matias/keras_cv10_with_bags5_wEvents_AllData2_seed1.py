...
pred_train_df.to_csv(
    "preds/keras_pred_train_bags5_wEvents_allData2_20160824_seed1.csv",
    index=True,
    index_label="device_id",
)
pred_test_df.to_csv(
    "preds/keras_pred_test_bags5_wEvents_allData2_20160824_seed1.csv",
    index=True,
    index_label="device_id",
)
...
submission.to_csv(
    "preds/keras_cv10_with_bags5_wEvents_AllData_Mix2_seed1.csv", index=True
)
